...
exports.loginUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!(error instanceof ErrorHandler_1.default)) {
            error = new ErrorHandler_1.default("Internal Server Error", 500);
        }
...
exports.logoutUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        redis_1.redis.del(userId); // Delete the token from Redis
        res.status(200).json({
            success: true,
...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const refreshToken = jsonwebtoken_1.default.sign({ id: user.id }, process.env.REFRESH_TOKEN, {
            expiresIn: "3d",
        });
        req.user = user;
...
exports.updateProfilePicture = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const user = await user_model_1.default.findById(userId);
        if (avatar && user) {
            //if user have an avatar then call ii
